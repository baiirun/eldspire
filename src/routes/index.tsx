    ...
    <div class="space-y-6">
      ...
      <section class="space-y-2">
        ...
        <ul class="list-disc pl-6 space-y-1">
          <li>
            <Link to="/pages/$slug" params={{ slug: "eldspire" }} class="underline">
              Eldspire
            </Link>{" "}
            - The towering capital city
          </li>
          <li>
            <Link to="/pages/$slug" params={{ slug: "verdant-kingdom" }} class="underline">
              Verdant Kingdom
            </Link>{" "}
            - A prosperous nation of lush forests
          </li>
          <li>
            <Link to="/pages/$slug" params={{ slug: "archmage-velorin" }} class="underline">
              Archmage Velorin
            </Link>{" "}
